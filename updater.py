...
class AutoUpdater:
    ...
    def should_update(self) -> bool:
        if os.environ.get("E.V._SKIP_UPDATE", "").lower() in {"1", "true", "yes"}:
    ...
    def apply_update(self) -> bool:
        ...
        try:
            with tempfile.TemporaryDirectory(prefix="ev-update-", dir=str(self.base_dir)) as temp_dir:

"""
office_builder.py - E.V. office document generation
...
PROJECT_NAME = "E.V."
DEFAULT_OUTPUT_DIR = Path.home() / "Desktop" / "E.V.AI"
...
def _resolve_output_path(output_path: str | None, title: str, ext: str) -> Path:
    ...
    return DEFAULT_OUTPUT_DIR / f"{_sanitize_filename(title, 'ev_ai_output')}{ext}"
